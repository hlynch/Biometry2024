...
#  })  
  ...
  output$Plot_sample <-renderPlot({
    plot(rand_samp(),main="",xlab="Sample index",ylab="Value",pch=16,col=rgb(225/255,74/255,141/255,0.5),ylim=c(0,1))
  },
