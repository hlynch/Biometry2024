...
library(knitr)
library(kableExtra)
df <- data.frame(Parameters = c("1", "2","3", "4"), 
                 "CI_90th" = c("qchisq(0.90,1)/2 = 1.353", "qchisq(0.90,2)/2 = 2.303","qchisq(0.90,3)/2 = 3.126","qchisq(0.90,4)/2 = 3.890"), 
                 "CI_95th" = c("qchisq(0.95,1)/2 = 1.921", "qchisq(0.95,2)/2 = 2.996","qchisq(0.95,3)/2 = 3.907","qchisq(0.95,4)/2 = 4.744"),
                 "CI_99th" = c("qchisq(0.99,1)/2 = 3.317", "qchisq(0.99,2)/2 = 4.605","qchisq(0.99,3)/2 = 5.672","qchisq(0.99,4)/2 = 6.638"))
kable(df, col.names = c("Parameters", "CI_90th", "CI_90th","CI_90th"), escape = F, caption = "The difference between the minimum NLL at the MLE and the NLL associated with the upper and lower confidence interval limits.",table.attr = "style='width:90%;'") %>%
