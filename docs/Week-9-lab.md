...
## -14.894  -5.472  -2.434   3.880  26.152 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  -0.4966     3.4447  -0.144    0.886    
## X            -2.1698     0.1940 -11.183 7.72e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.199 on 28 degrees of freedom
## Multiple R-squared:  0.8171,	Adjusted R-squared:  0.8105 
## F-statistic:   125 on 1 and 28 DF,  p-value: 7.722e-12
```
...
## t1* 6.3002197  0.43165228  4.59265048
## t2* 0.6615263 -0.00806164  0.07495124
```
